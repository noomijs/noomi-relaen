...
class BaseEntity {
     ...
     */
    compare(obj) {
        const ecfg = entityfactory_1.EntityFactory.getEntityConfig(this.constructor.name);
        for (const col of ecfg.columns) {
            ...
            if (!fo.refName && obj[fn] !== this[fn] ||
                obj[fn] !== entityfactory_1.EntityFactory.getIdValue(this)) {
                return false;
            }
        }
        return true;
    ...
    clone() {
        ...
        for (const col of ecfg.columns) {
            ...
            if (fo.refName) { //外键只取id
                if (this[col[0]] !== null) {
                    obj[col[0]] = entityfactory_1.EntityFactory.getIdValue(this[col[0]]);
                }
            }
            else {
                //null也需要保留
