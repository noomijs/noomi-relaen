...
exports.ManyToMany = exports.ManyToOne = exports.OneToOne = exports.OneToMany = exports.JoinColumn = exports.JoinTable = exports.Version = exports.Column = exports.Id = exports.Entity = void 0;
...
function Entity(tblName, schema) {
    return (target) => {
        entityfactory_1.EntityFactory.addEntityConfig(target, tblName, schema);
    };
}
...
function Version() {
    return (target, propertyName) => {
        entityfactory_1.EntityFactory.addVersion(target.constructor.name, propertyName);
    };
}
...
function JoinTable(cfg) {
    return (target, propertyName) => {
        ...
        entityfactory_1.EntityFactory.addColumn(target.constructor.name, propertyName, cfg1);
    };
}
